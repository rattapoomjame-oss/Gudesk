...
def build_flutter_dmg(version, features):
    ...
    # GuDesk rebrand: the actual built app is GuDesk.app (Xcode TARGET_NAME), not RustDesk.app.
    system2('cp -rf ../target/release/service ./build/macos/Build/Products/Release/GuDesk.app/Contents/MacOS/')
    '''
    system2(
